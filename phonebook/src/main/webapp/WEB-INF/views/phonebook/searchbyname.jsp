...
<body>
	<header>
		...
		<table class="table align-middle mb-0 bg-white w-75" id="table_id">
			...
			<tbody>
				<c:forEach var="searchname" items="${searchnamelist}" varStatus="status">

					<tr>
						<td>
							<div class="d-flex align-items-center">
								<div class="ms-3">
									<p class="fw-bold mb-1">${searchname.membernm}</p>
									<p class="text-muted mb-0">${searchname.userid}</p>
								</div>
							</div>
						</td>
						<td>
							<p class="fw-normal mb-1" id="phonenumber">${searchname.phonenumber}</p>
						</td>
						<td><c:if test="${searchname.groupnm == '가족'}">
								<span class="badge badge-success rounded-pill d-inline">가족</span>
							</c:if> <c:if test="${searchname.groupnm == '친구'}">
								<span class="badge badge-primary rounded-pill d-inline">친구</span>
							</c:if> <c:if test="${searchname.groupnm == '기타'}">
						...
						<td>
							...
							<button type="button"
								...
								data-mdb-target="#exampleModal${searchname.phonenumber}"
								data-mdb-ripple-color="dark">
								<i class="fas fa-pen-to-square"></i>
							</button> <!-- Modal -->
							<div class="modal fade" id="exampleModal${searchname.phonenumber}"
								tabindex="-1" aria-labelledby="exampleModalLabel"
								aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel">${searchname.membernm}의
												연락처 수정</h5>
										...
										<div class="modal-body mx-4">
											<form method=post
												action="/phonebook/login/update?phonenumber=${searchname.phonenumber}"
												...
												<div class="form-outline mb-4">
													<input type="text" name="phonenumber"
														value="${searchname.phonenumber}" id="form3Example1"
						...
						<td>
							<!-- 삭제 버튼 --> <a href="/phonebook/delete/${searchname.phonenumber}"><span
